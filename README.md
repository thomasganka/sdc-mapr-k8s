...
Launch the Deployment with Control Hub and Control Agent, using the <code>sdc-mapr-dep.yaml</code>. A <code>sdc-mapr-svc.yaml</code> is included for NodePort access.
...
<img src="images/config.png" alt="config" width="800"/>
