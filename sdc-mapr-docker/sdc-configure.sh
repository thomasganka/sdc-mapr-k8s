...
#addgroup --system --gid ${SDC_GID} ${SDC_USER} && \
#    adduser --system --disabled-password -u ${SDC_UID} --group ${SDC_USER} ${SDC_USER}

adduser --system --no-create-home ${SDC_USER}
